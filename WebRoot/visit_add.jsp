...
<html>
  <head>
    ...
    <title>My JSP 'visit_add.jsp' starting page</title>
...
function back(){
  ...
  <body onload="getMyMonth()">
   <div class="" align="center" style="margin-top: 50px;">
			<h2 style="margin-bottom: 30px;">来访者信息录入</h2>
		<form id="regForm" style="width: 700px;" class="form-horizontal form-inline" method="post" onsubmit="return checkForm()" action="VisitServlet.action?flag=addvisit">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="userId" name="userId"  onblur="checkForm(this.value)" />
					<span class="pull-left"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text" id="stime" name="stime" onblur="checkForm(this.value)"/>
			...
			<div class="control-group">
				...
				<div class="controls">
				    <input class="input-block-level" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text" id="etime" name="etime" onblur="checkForm(this.value)"/>
					<br> <span class="pull-left"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="text input-block-level" type="text" id="idcard" name="idcard"  onblur="checkForm(this.value)" />
					<br> <span class="pull-left"></span>
				</div>
			</div>
