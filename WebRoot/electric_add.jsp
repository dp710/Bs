...
<html>
  <head>
    ...
    <title>My JSP 'electric_add.jsp' starting page</title>
...
function back(){
  ...
  <body>
   ...
   <div class="" align="center" style="margin-top: 50px;">
			<h2 style="margin-bottom: 30px;">电表信息录入</h2>
		<form id="regForm" style="width: 700px;" class="form-horizontal form-inline" method="post" onsubmit="return checkForm()" action="ElectricServlet.action?flag=addelectric">
			
			<font id="error" color="red"></font>
			<div class="control-group">
				<label class="control-label" for="month">当前时间：</label>
				<div class="controls">
					<input class="input-block-level" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  type="text" id="month" name="month" onblur="checkForm(this.value)"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="price" name="price" value="1" onblur="checkForm(this.value)" />			
					<span class="pull-left"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="amount" name="amount" onblur="checkForm(this.value)" />
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="pay" 
					name="pay" onblur="checkForm(this.value)" />
					<br> <span class="pull-left"></span>
				</div>
			</div>
