...
<html>
  <head>
    ...
    <title>My JSP 'water_add.jsp' starting page</title>
...
function back(){
  ...
  <body onload="getMyMonth()">
   <div class="" align="center" style="margin-top: 50px;">
			<h2 style="margin-bottom: 30px;">水表信息录入</h2>
		<form id="regForm" style="width: 700px;" class="form-horizontal form-inline" method="post" onsubmit="return checkForm()" action="WaterServlet.action?flag=addwater">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="price" name="price" value="5" onblur="checkForm(this.value)" />			
					<span class="pull-left"></span>
				</div>
			</div>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input class="input-block-level" type="text" id="weight" name="weight" onblur="checkForm(this.value)" />
